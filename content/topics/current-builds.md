...
en:
  ...
  keywords:
    ...
    - "mvp"
  response: |-
    Three live builds, all solo-orchestrated with AI in the loop:
...
ru:
  ...
  chip_label: "Текущие билды"
  prompt: "Что вы сейчас делаете?"
  keywords:
    - "сейчас делаете"
    - "текущие проекты"
    - "что строите"
    - "mvp"
  response: |-
    Сейчас у меня 3 live-направления:
