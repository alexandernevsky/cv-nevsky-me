...
en:
  label: "Fundmates"
  chip_label: "Fundmates"
  prompt: "Tell me about Fundmates."
  keywords:
    - "fundmates"
    - "youtube"
    - "creators"
    ...
    - "creator economy"
body_en: |-
  **Fundmates** is a US startup that raises capital for YouTube creators. Over several months in 2025 I ran design sprints with the team on two surfaces.
...
ru:
  label: "Fundmates"
  chip_label: "Fundmates"
  prompt: "Расскажите про Fundmates."
  keywords:
    - "fundmates"
    - "ютуб"
    - "креаторы"
    - "финансирование"
body_ru: |-
  Fundmates — стартап, который финансирует YouTube-креаторов.
